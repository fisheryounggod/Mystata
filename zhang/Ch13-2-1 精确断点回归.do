...
/*--2--【精确断点】回归------------------------*/
/*------由于，此处，处理变量win【完全】由分组变量d是否大于等于0所决定，
        因此，rd命令中【可以省略】处理变量win-------------------------*/
 
 
/*--2-1--选择最优窗宽：设置不同窗宽，通过图形选择----*/ 
...
*从25~300，间隔为5中，选一个最优的。
  rd lne d, mbw(25(5)300) bdep ox
  
  
*含协变量情形，从25~300，间隔为5中，选一个最优的。
  rd lne d, mbw(25(5)300) covar(i votpop black blucllr ///
...
* 将默认的3种窗宽mbw(100,50,200)对应的情形都估计一遍。
  rd lne d, covar(i votpop black blucllr ///
             fedwrkr forborn manuf unemplyd union ///
			 urban veterans)  		 
