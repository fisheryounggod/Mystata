...
/*----1-2--用【OLS】估计【没有协变量】的【三重差分】估计量-----------*/

  reg fte bk treated c.bk#c.treated t c.t#c.bk c.t#c.treated ///
           c.t#c.bk#c.treated, robust
		   
  esti stor DDDOLS1

  
/*--【注意】--可以通过观察c.t#c.treated的系数的显著性，
              来判断即便【没有新政策】的情形下，
		      实验组和控制组的【时间趋势】是否相同？----*/	  
  
* 【注意】此处，通过检验c.t#c.treated的系数的显著性，发现，其不显著，
*         即表明即便没有新政策的情形下，实验组和控制组的时间趋势是【相近的】。
*         因此，该问题采用【双重差分法】即可。
  
  
*  ssc install st0085_2            /*----安装非Stata系统软件包----*/
  esttab DDD1 DDDOLS1 using testldddols1.doc, ar2(%8.4f) se(%8.4f) ///  
...
*  ssc install st0085_2            /*----安装非Stata系统软件包----*/
  esttab DDDCOV1 DDDCOVOLS1 using testldddcovols1.doc, ar2(%8.4f) se(%8.4f) ///  
	     nogap brackets aic bic  mtitles replace	  
